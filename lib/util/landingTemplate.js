...
function landingTemplate(manifest, config) {
	...
	<form class="pure-form" id="mainForm">
		...
		<div class="form-element">
			<div class="label-to-top">MediaFlow Proxy URL <span style="font-weight:normal;opacity:0.7">(optional)</span>
				<div style="font-weight:normal;opacity:0.6;font-size:1.5vh;margin-top:0.3vh">Routes streams through your proxy so Real-Debrid only sees your MediaFlow server's IP</div>
			</div>
