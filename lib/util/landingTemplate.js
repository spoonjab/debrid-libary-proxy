	...
	<div id="manifestUrlBox">
		...
		<div class="form-element">
			...
			<div style="display:flex;gap:1vh">
				<div class="manifest-url-wrap full-width">
					<input type="text" id="manifestUrl" class="full-width" readonly style="cursor:pointer" onclick="this.select()" placeholder="Fill in your Debrid Provider and API Key above">
